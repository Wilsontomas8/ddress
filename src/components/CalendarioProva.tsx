  ...
  return (
    <div>
      ...
      {dados?.peca && dados.peca.exemplares > 0 && !dados.peca.disponivel && (
        <p className="mb-3 border-l-2 border-vinho bg-areia-100 px-3 py-2 text-sm text-tinta-70">
      ...
      {!aCarregar && !erro && diasAbertos.length === 0 && (
        <p className="cartao p-4 text-sm text-tinta-70">
          ...
          <button
            type="button"
            className="text-vinho underline underline-offset-4"
      ...
      {diasAbertos.length > 0 && (
        <>
                  ...
                  <button
                    ...
                    className={`shrink-0 border px-3 py-2 text-center transition-colors ${
                      ativo
                        ...
                        : "border-areia-300 bg-white text-tinta hover:border-tinta"
                    }`}
                  >
                      ...
                      className={`border px-2 py-2 text-sm transition-colors ${
                        escolhido
                          ...
                          : s.disponivel
                            ...
                            : "cursor-not-allowed border-areia-200 bg-areia-100 text-tinta-50 line-through"
                      }`}
                    >
                      {s.hora}
                    </button>
          ...
          {valor && (
            <p className="mt-3 border-l-2 border-verde bg-areia-100 px-3 py-2 text-sm">
