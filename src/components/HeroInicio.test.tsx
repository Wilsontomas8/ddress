...
const slides: Slide[] = [
  { id: "a", rotulo: "Primeiro", titulo: ["Vista a peça", "certa."], texto: "Texto A", principal: { href: "/loja", texto: "Ver a colecção" } },
  { id: "b", rotulo: "Segundo", titulo: ["Prove antes.", "Leve depois."], texto: "Texto B", principal: { href: "/marcacao", texto: "Marcar prova" } },
];
const video: VideoDeFundo = { src: "/v.mp4", poster: "/v.jpg", vertical: true };
...
describe("vídeo da página inicial", () => {
  test("mostra o primeiro slide com o título e a acção", () => {
    render(<HeroInicio slides={slides} video={video} />);
