...
async function main() {
  console.log("A limpar as tabelas...");
  ...
  // ---------------------------------------------------------- definições
  console.log("Definições da loja...");
  ...
  // ------------------------------------------------- pedidos de exemplo
  console.log("Pedidos e marcações de demonstração...");
  ...
  await db.insert(orderItems).values({
    id: item1,
    orderId: pedido1,
    productId: (await produtoIdPorSlug("vestido-gala-bordeaux"))!,
    variantId: variante1,
  ...
  await db.insert(orderItems).values([
    {
      id: uid(),
      orderId: pedido2,
      productId: (await produtoIdPorSlug("camisa-linho-branca"))!,
      variantId: variante2,
    ...
    },
    {
      id: uid(),
      orderId: pedido2,
      productId: (await produtoIdPorSlug("calcas-chino-caqui"))!,
      variantId: variante3,
  ...
  await db.insert(orderItems).values({
    id: item4,
    orderId: pedido4,
    productId: (await produtoIdPorSlug("smoking-preto-gala"))!,
    variantId: smoking52,
  ...
  await db.insert(appointments).values({
    ...
    productId: await produtoIdPorSlug("vestido-cerimonia-dourado"),
  ...
  console.log("");
  console.log("  Pronto.");
  console.log(`  ${totalProdutos} produtos, ${varianteIds.size} peças, 4 pedidos, 2 marcações.`);
  console.log("");
  console.log("  Contas de acesso:");
  console.log("    Administrador   admin@ddress.ao       admin123");
  console.log("    Funcionário     domingos@ddress.ao    funcionario123");
  console.log("    Funcionária     ana@ddress.ao             funcionario123");
  console.log("    Suporte         suporte@ddress.ao         suporte123");
  console.log("    Contabilista    contabilidade@ddress.ao   conta123");
  console.log("    Motorista       motorista@ddress.ao       motorista123");
  console.log("    Cliente         cliente@exemplo.ao        cliente123");
  console.log("");
}

/** Devolve o id do produto a partir do slug */
async function produtoIdPorSlug(slug: string): Promise<string | null> {
